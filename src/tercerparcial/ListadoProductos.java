...
public class ListadoProductos extends javax.swing.JDialog {
    ...
    public ListadoProductos(java.awt.Frame parent, boolean modal) {
       ...
       public void pintarTabla() {
        ...
        String[] columnas = {"CODIGO","NOMBRE","TIPO","COSTO","PRECIO","CANTIDAD"};
        modelo.setColumnIdentifiers(columnas);
        for (Producto p : listaProductos) {
            String[] fila = {String.valueOf(p.getCodigo()), p.getNombre(), p.getTipo(), String.valueOf(p.getCosto()), String.valueOf(p.getPrecio()), String.valueOf(p.getCantidad())};
            modelo.addRow(fila);
        }
